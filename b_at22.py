    ...
    try:
        ...
        if ((position['type'] is None) or (position['type']=='long' and buy_phase <= 1 and roe < -3)) :
            ...
            if slow_k_30m[-1] <= 90 and slow_k_30m[-1] > slow_d_30m[-1] :
                print(now,"long")
                if slow_k_5m[-1] <= 80 and slow_k_5m[-1] > slow_d_5m[-1]  :
                    ...
                    elif macd_1m[-2] <= macd_signal_1m[-2] and macd_1m[-1] > macd_signal_1m[-1]  :
                        position['type'] = 'long'
                        if buy_phase == 0 :
                            buy_phase = 1
        ...
        if ((position['type'] is None) or (position['type']=='short' and buy_phase <= 1 and roe < -3))  :
            ...
            if slow_k_30m[-1] >= 10 and slow_k_30m[-1] < slow_d_30m[-1]  :
                print(now,"short")
                if slow_k_5m[-1] >= 20 and slow_k_5m[-1] < slow_d_5m[-1]  :
                    # 
                    if macd_5m[-2] >= macd_signal_5m[-2] and macd_5m[-1] < macd_signal_5m[-1]  :
                        position['type'] = 'short'
                        if buy_phase == 0 :
