...
while True: 
    try:
        ...
        # 과거 조회
        btc_ohlcv_5m = binance.fetch_ohlcv(symbol="BTC/USDT", timeframe='5m', since=None, limit=30)
        ...
        btc_ohlcv_30m = binance.fetch_ohlcv(symbol="BTC/USDT", timeframe='15m', since=None, limit=30)
        ...
        buy_status = 0
        # Enter  
        if ((position['type'] is None) or (position['type']=='long' and buy_phase <= 2 and roe < -5)) :
            ...
            print(now,"long")
            if slow_k_30m[-2] <= 20 and slow_k_30m[-2] < slow_k_30m[-1] :
                print("long1") 
                if slow_k_5m[-2] <= 20   :
                    # 
            ...
            #long조건2
            if slow_k_30m[-2] <= 90 and slow_k_30m[-1] > slow_d_30m[-1] and buy_status == 0 :
                # and slow_k_30m[-2] < slow_k_30m[-1]  and macd_osc_30m[-2] < macd_osc_30m[-1]
                print("long2")
                if slow_k_5m[-2] <= 60 and slow_k_5m[-2] <= slow_d_5m[-2] and slow_k_5m[-1] > slow_d_5m[-1]  :
                    #and macd_5m[-2] < macd_5m[-1] and macd_osc_5m[-2] < macd_osc_5m[-1] and slow_k_5m[-2] < slow_k_5m[-1]
            ...
            if slow_k_30m[-2] <= 90 and slow_k_30m[-1] > slow_d_30m[-1] and buy_status == 0 :
                print("long3")
                if slow_k_5m[-2] <= 90 and macd_5m[-1] > macd_signal_5m[-1] :
                    # and slow_k_5m[-1] > slow_d_5m[-1]  and macd_1m[-1] > macd_signal_1m[-1]
                    if slow_k_1m[-2] <= 20 and slow_k_1m[-2] <= slow_d_1m[-2] and slow_k_1m[-1] > slow_d_1m[-1] and macd_osc_1m[-2] < macd_osc_1m[-1]  :
                        position['type'] = 'long'
                        if buy_phase == 0 :
                            buy_phase = 1
            ...
            if slow_k_30m[-2] <= 90 and slow_k_30m[-1] > slow_d_30m[-1] and buy_status == 0 :
                # and slow_k_30m[-2] < slow_k_30m[-1] and macd_osc_30m[-2] < macd_osc_30m[-1]
                print("long4")
                if slow_k_5m[-2] <= 20 and macd_osc_5m[-2] < macd_osc_5m[-1] and macd_5m[-2] < macd_5m[-1] :
        ...
        if ((position['type'] is None) or (position['type']=='short' and buy_phase <= 2 and roe < -5))  :
            ...
            print(now,"short")
            if slow_k_30m[-2] >= 80 and slow_k_30m[-2] > slow_k_30m[-1] and buy_status == 0  :
                print("short1")
                if slow_k_5m[-2] >= 80  :
                    # 
                    if  slow_k_1m[-2] >= 80 and slow_k_1m[-2] >= slow_d_1m[-2] and slow_k_1m[-1] < slow_d_1m[-1] and macd_osc_1m[-2] > macd_osc_1m[-1] :
                        ...
                        bot.sendMessage(mc, buy_msg )
            #short조건2
            if slow_k_30m[-2] >= 10 and slow_k_30m[-1] < slow_d_30m[-1] and buy_status == 0  :
                # and slow_k_30m[-2] > slow_k_30m[-1] and macd_osc_30m[-2] > macd_osc_30m[-1]
                print("short2")
                if slow_k_5m[-2] >= 40 and slow_k_5m[-2] >= slow_d_5m[-2] and slow_k_5m[-1] < slow_d_5m[-1]  :
                    # and macd_5m[-1] < macd_signal_5m[-1] and macd_1m[-1] < macd_signal_1m[-1] and macd_5m[-2] > macd_5m[-1] and macd_osc_5m[-2] > macd_osc_5m[-1] and slow_k_5m[-2] > slow_k_5m[-1]
                    if slow_k_1m[-2] >= 50 and slow_k_1m[-2] >= slow_d_1m[-2] and slow_k_1m[-1] < slow_d_1m[-1] and macd_osc_1m[-2] > macd_osc_1m[-1] :
                        position['type'] = 'short'
                        if buy_phase == 0 :
                            buy_phase = 1
            ...
            if slow_k_30m[-2] >= 10 and slow_k_30m[-1] < slow_d_30m[-1] and buy_status == 0  :
                print("short3")
                if slow_k_5m[-2] >= 10 and macd_5m[-1] < macd_signal_5m[-1] :
                    # and macd_1m[-1] < macd_signal_1m[-1] and slow_k_5m[-1] < slow_d_5m[-1] and macd_1m[-1] < macd_signal_1m[-1]
                    if slow_k_1m[-2] >= 80 and slow_k_1m[-2] >= slow_d_1m[-2] and slow_k_1m[-1] < slow_d_1m[-1] and macd_osc_1m[-2] > macd_osc_1m[-1]  :
                        position['type'] = 'short'
                        if buy_phase == 0 :
                            buy_phase = 1
            ...
            #short조건4
            if slow_k_30m[-2] >= 10 and slow_k_30m[-1] < slow_d_30m[-1] and buy_status == 0  :
                # and slow_k_30m[-2] > slow_k_30m[-1] and macd_osc_30m[-2] > macd_osc_30m[-1] and slow_k_5m[-2] >= 80
                print("short4")
                if slow_k_5m[-2] >= 80 and macd_osc_5m[-2] > macd_osc_5m[-1] and macd_5m[-2] > macd_5m[-1]  :
                    # 
                    if slow_k_5m[-2] >= slow_d_5m[-2] and slow_k_5m[-1] < slow_d_5m[-1] :
                        position['type'] = 'short'
                        if buy_phase == 0 :
        ...
        if buy_phase >= 1 :
            ...
            if position['type'] == 'long':  # or slow_k_30m[-1] <= slow_d_30m[-1] and slow_k_5m[-1] >= 50 and slow_k_1m[-2] >= 50
                if slow_k_30m[-1] >= 80 and slow_k_5m[-1] >= 80 and slow_k_1m[-2] >= 50 and slow_k_1m[-2] >= slow_d_1m[-2] and slow_k_1m[-1] < slow_d_1m[-1] and macd_osc_1m[-2] > macd_osc_1m[-1]  :
                    binance.create_market_sell_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "long 청산(1) : "+str(roe)+"%")
                    buy_phase=0
                elif 8 <= buy_condition <= 9 and slow_k_30m[-2] >= slow_d_30m[-2] and slow_k_30m[-1] < slow_d_30m[-1] :
                    binance.create_market_sell_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "long 청산(2) : "+str(roe)+"%")
                    buy_phase=0
                elif slow_k_5m[-2] >= 80 and slow_k_1m[-2] >= slow_d_1m[-2] and slow_k_1m[-1] < slow_d_1m[-1] and macd_osc_1m[-2] > macd_osc_1m[-1] :
                    binance.create_market_sell_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "long 청산(3) : "+str(roe)+"%")
                    buy_phase=0
                elif (slow_k_30m[-2] >= 75 or roe > 3) and slow_k_5m[-2] >= slow_d_5m[-2] and slow_k_5m[-1] < slow_d_5m[-1] :
                    binance.create_market_sell_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "long 청산(4) : "+str(roe)+"%")
                    buy_phase=0
                elif 8 <= buy_condition <= 9 and macd_5m[-2] >= macd_signal_5m[-2] and macd_5m[-1] < macd_signal_5m[-1] and slow_k_5m[-1] < slow_d_5m[-1] :
                    binance.create_market_sell_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "long 청산(5) : "+str(roe)+"%")
                    buy_phase=0
                elif buy_condition == 9 and slow_k_1m[-2] >= 80 and slow_k_1m[-2] >= slow_d_1m[-2] and slow_k_1m[-1] < slow_d_1m[-1] and macd_osc_1m[-2] > macd_osc_1m[-1] :
                    binance.create_market_sell_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "long 청산(6) : "+str(roe)+"%")
                    buy_phase=0
                elif roe > TP_target :
                    binance.create_market_sell_order(symbol=symbol, amount=amount)
                    time.sleep(1)
            ...
            if position['type'] == 'short':  #   or slow_k_30m[-1] >= slow_d_30m[-1])
                if slow_k_30m[-1] <= 20 and slow_k_5m[-1] <= 20 and slow_k_1m[-2] <= 50 and slow_k_1m[-2] <= slow_d_1m[-2] and slow_k_1m[-1] > slow_d_1m[-1] and macd_osc_1m[-2] < macd_osc_1m[-1]  :
                    ...
                    buy_phase=0
                elif slow_k_5m[-2] <= 20 and slow_k_1m[-2] <= slow_d_1m[-2] and slow_k_1m[-1] > slow_d_1m[-1] and macd_osc_1m[-2] < macd_osc_1m[-1]  :
                    binance.create_market_buy_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "short 청산(3) : "+str(roe)+"%")
                    buy_phase=0   
                elif (slow_k_30m[-2] <= 25 or roe > 3) and slow_k_5m[-2] <= slow_d_5m[-2] and slow_k_5m[-1] > slow_d_5m[-1] :
                    binance.create_market_buy_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "short 청산(4) : "+str(roe)+"%")
                    buy_phase=0 
                elif 8 <= buy_condition <= 9 and macd_5m[-1] <= macd_signal_5m[-1] and macd_5m[-1] > macd_signal_5m[-1] and slow_k_5m[-1] > slow_d_5m[-1] :
                    binance.create_market_buy_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "short 청산(5) : "+str(roe)+"%")
                    buy_phase=0 
                elif buy_condition == 9 and slow_k_1m[-2] <= 20 and slow_k_1m[-2] <= slow_d_1m[-2] and slow_k_1m[-1] > slow_d_1m[-1] and macd_osc_1m[-2] < macd_osc_1m[-1]  :
                    binance.create_market_buy_order(symbol=symbol, amount=amount)
                    time.sleep(1)
                    position['type'] = None 
                    bot.sendMessage(mc, "short 청산(6) : "+str(roe)+"%")
                    buy_phase=0   
                elif roe > TP_target : 
                    binance.create_market_buy_order(symbol=symbol, amount=amount)
                    time.sleep(1)
